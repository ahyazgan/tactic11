    ...
    >
      ...
      <div className="st" style={{ marginTop: 0 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          <button type="button" onClick={() => setSent(true)} disabled={sent} style={{ padding: "8px 14px", borderRadius: 9, border: 0, background: sent ? "var(--low)" : "var(--besiktas)", color: "#fff", fontWeight: 700, fontSize: 12.5, cursor: sent ? "default" : "pointer", fontFamily: "inherit", opacity: sent ? 0.85 : 1 }}>
            <i className={`ti ${sent ? "ti-check" : "ti-send"}`} style={{ marginRight: 6 }} />{sent ? "Gönderildi" : "Direktöre gönder"}
          </button>
        </div>
      </div>
