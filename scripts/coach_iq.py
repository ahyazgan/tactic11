...
def main() -> int:
    ...
    print("    (isabet@1 UYARISI: motor doğru GRUBU biliyor, doğru KİŞİYİ değil. Grup "
          "İÇİNDE altı olay-türevi sinyal iki yönde sınandı, ayrık yarıda kazanç +0.001, "
          "permütasyon p=0.62 — bu yön KAPALI; bkz. docs/KARNE-GRUP-ICI-SINYAL.md)")
